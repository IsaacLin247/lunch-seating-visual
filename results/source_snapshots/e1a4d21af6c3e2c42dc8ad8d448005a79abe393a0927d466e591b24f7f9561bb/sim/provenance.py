...
def trace_provenance(net, lists, run_config, generator_config=None, extra_inputs=None) -> dict:
    ...
    ``extra_inputs`` (staff constraints, explicit attendance, waivers, a
    non-default objective) are feasibility inputs and enter the input hash.
    """
